...
It has two modules, one is the admin module where the owner of the blood bank updates the stock and other is the user module where the user can search for the blood banks based on their requeried location. It displays the blood banks information based on the given location and blood group.We developed this project using HTML, CSS, PHP, JAVASCRIPT, BOOTSTRAP and MYSQL.
